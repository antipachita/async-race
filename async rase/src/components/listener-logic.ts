...
export function createInputListeners(firstInputElement: HTMLInputElement, secondInputElement: HTMLInputElement) {
...
export function createSortBtnsListeners(elem: Element, sortType: string, orderType: string) {
