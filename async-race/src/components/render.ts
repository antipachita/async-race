...
class Render {
  ...
  renderwinners(): void {
    ...
    <table id="table">
      <thead>
        <tr>
          ...
          <th>Car</th>
          <th>Name</th>
          <th id="wins-colum">Wins 
            <p><i id="wins-up-sort-arrow" class="up"></i></p>
            <p><i id="wins-down-sort-arrow" class="down"></i></p>
          </th>
          <th id="time-colum">Best time
            <p><i id="time-up-sort-arrow" class="up"></i></p>
            <p><i id="time-down-sort-arrow" class="down"></i></p>
          </th>
        </tr>
      </thead>
      <tbody class="tbody">
    ...
    <div class="winner-nav-panel">
      <div class="winner-page-btn winner-prev-btn">prev</div>
      <div class="winner-page-btn winner-next-btn">next</div>
     </div>
    `;
  }

  renderWinner(winner: IWinner, num: number, name: string, color: string):void {
